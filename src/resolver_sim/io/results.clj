...
(defn write-csv
  ...
  (with-open [writer (io/writer filepath)]
    ...
    (.write writer "strategy,n_trials,honest_mean,honest_std,honest_min,honest_max,honest_p50,malice_mean,malice_std,malice_min,malice_max,malice_p50,dominance_ratio,appeal_rate,escalation_rate,l2_escalation_rate\n")
    ...
    (doseq [result (if (sequential? results) results [results])]
      (let [{:keys [strategy n-trials honest-mean honest-std honest-min honest-max honest-p50
                    ...
                    appeal-rate escalation-rate l2-escalation-rate]} result]
