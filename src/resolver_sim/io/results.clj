...
(defn write-csv
  ...
  (with-open [writer (io/writer filepath)]
    ; Header
    (.write writer "strategy,n_trials,honest_mean,honest_std,honest_min,honest_max,honest_p50,malice_mean,malice_std,malice_min,malice_max,malice_p50,dominance_ratio\n")
    ...
    (doseq [result (if (sequential? results) results [results])]
      (let [{:keys [strategy n-trials honest-mean honest-std honest-min honest-max honest-p50
                    malice-mean malice-std malice-min malice-max malice-p50 dominance-ratio]} result]
        (.write writer (format "%s,%d,%.2f,%.2f,%d,%d,%.2f,%.2f,%.2f,%d,%d,%.2f,%.2f\n"
