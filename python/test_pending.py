...
# Quick test - check pending-fraud-slashes after propose
with SimulationClient(port=50051) as client:
    with managed_session(client, [
    ...
    ], session_id='debug-pending-001', initial_block_time=1000) as sid:
        ...
        # CHECK WORLD STATE - pending-fraud-slashes
        ...
        # Try withdraw stake WITH pending slash
